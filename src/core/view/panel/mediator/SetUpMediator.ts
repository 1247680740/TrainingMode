...
module game {
    ...
    export class SetUpMediator extends BaseMediator {
        ...
        public handleNotification(notification: puremvc.INotification): void {
            ...
            switch (notification.getName()) {
                case NoficationConfig.OPEN_SETUP: {
                    this.changeBg();
                    this.showUI(this.setupPanel, false, 0, 0, 6);
                    break;
                }
        ...
        private saveData(): void {
            EffectUtils.playEffect(this.setupPanel.btn_save, 2, this.sendNofiCation, 1);
        }

        private back(): void {
            EffectUtils.playEffect(this.setupPanel.btn_cancle, 2, this.sendNofiCation, 2);
        }
        ...
        private checkTimeTag(): void {
            ...
            GlobalData.checkType = !GlobalData.checkType;
            this.judgeCheck();
        }

        private checkTaskTag(): void {
            if (GlobalData.checkType == false) {
                return;
            }
            GlobalData.checkType = !GlobalData.checkType;
            this.judgeCheck();
